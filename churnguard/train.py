...
def train_model(
    ...
    """Entraîne le modèle demandé et log optionnellement dans MLflow."""
...
def promotion_to_laprod():
    ...
    client.set_registered_model_alias(
        name=MODEL_NAME, alias=PROD, version=registered_model.version
    )
...
def __fit_and_log_model_to_mlflow(  # pragma: no cover
    model: Pipeline,
    model_name: str,
    params: dict,
    X_train,
